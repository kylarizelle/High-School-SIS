                    ...
                    While($row = mysqli_fetch_assoc($run)) {
                        ?>
                            <tr>
                                    ...
                                    <td><a href="grant_requests.php?adminID=<?php echo $row['adminID']; ?>"><button class='edit-administration'><i class='fa fa-check'></i></button></a><a href="del_request.php?admin_id=<?php echo $row['adminID']; ?>"><button class='delete-administration'><i class='fa fa-times'></i></button></a></td>
