  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav navi">
      <li class="nav-item active">
        <a class="nav-link" href="announcement_stud.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="stud_grades.php">Grades</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="enrollment.php">Course</a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="#">Messages</a>
      </li>
	  <li class="nav-item set">
        <a class="nav-link" href="setting_stud.php">Profile</a>
      </li>
